...
class AccessLog(models.Model):
    ...
    class DenialReason(models.TextChoices):
        TOKEN_EXPIRED = 'TOKEN_EXPIRED', 'Token QR expirado'
        INVALID_SIGNATURE = 'INVALID_SIGNATURE', 'Firma de token inválida'
        INVALID_TOKEN = 'INVALID_TOKEN', 'Token QR malformado o sin identificador'
        REPLAY_ATTACK = 'REPLAY_ATTACK', 'Token QR ya utilizado'
        MEMBERSHIP_INACTIVE = 'MEMBERSHIP_INACTIVE', 'Membresía inactiva o cuota vencida'
